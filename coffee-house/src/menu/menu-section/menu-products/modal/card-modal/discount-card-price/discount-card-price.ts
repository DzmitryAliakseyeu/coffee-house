import { OrderI, ProductsDataI, UserSignInI } from "../../../../../../interfaces/interfaces";

export default function toggleDiscountCardPrice(product: ProductsDataI, userSignIn: UserSignInI, discount: number){
    ...
    if( (document.querySelector('.discount-card-price-modal') as HTMLElement)){
        (document.querySelector('.discount-card-price-modal') as HTMLElement).remove()
    }
